  ...
  (
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // biome-ignore lint/suspicious/noDocumentCookie: Legacy cookie approach needed for sidebar state persistence
...
const FloatingSidebarTrigger = React.forwardRef<
  React.ElementRef<typeof Button>,
  React.ComponentProps<typeof Button>
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      className={`fixed top-2 z-10 transition-all duration-200 ${
...
FloatingSidebarTrigger.displayName = 'FloatingSidebarTrigger';
