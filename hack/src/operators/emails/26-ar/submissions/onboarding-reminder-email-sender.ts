import OnboardingReminderEmail26Ar from '@/src/emails/submissions/onboarding-reminder-26-ar';
...
interface SendOnboardingReminderEmail26ArParams {
  submissionId: string;
...
export class OnboardingReminderEmailSender26Ar {
  async sendToAllMembers(
    params: SendOnboardingReminderEmail26ArParams,
  ): Promise<void> {
    try {
      ...
      for (const member of submissionDetails.members) {
        ...
        await sendEmail({
          templateName,
          template: OnboardingReminderEmail26Ar,
          templateProps: {
...
export const onboardingReminderEmailSender26Ar =
  new OnboardingReminderEmailSender26Ar();
