...
interface SendSelfFinanceReminderEmail25Params {
  submissionId: string;
}
...
export class SelfFinanceReminderEmailSender25 {
  async sendToAllMembers(
    params: SendSelfFinanceReminderEmail25Params,
  ): Promise<void> {
    try {
...
export const selfFinanceReminderEmailSender25 =
  new SelfFinanceReminderEmailSender25();
