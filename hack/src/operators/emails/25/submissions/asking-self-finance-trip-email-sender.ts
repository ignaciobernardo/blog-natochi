...
interface SendAskingSelfFinanceTripEmail25Params {
  submissionId: string;
  sentByUserId: string;
}
...
export class AskingSelfFinanceTripEmailSender25 {
  async sendToAllMembers(
    params: SendAskingSelfFinanceTripEmail25Params,
  ): Promise<void> {
    try {
...
export const askingSelfFinanceTripEmailSender25 =
  new AskingSelfFinanceTripEmailSender25();
