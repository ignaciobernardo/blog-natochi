...
-- Normalize country values in submissions table to two-letter ISO codes
UPDATE submissions
SET country = CASE
...
-- Normalize country values in hacker_profiles table to two-letter ISO codes
UPDATE hacker_profiles
SET country = CASE
  -- Plain text countries
  WHEN country = 'Argentina' THEN 'AR'
  WHEN country = 'Bolivia' THEN 'BO'
