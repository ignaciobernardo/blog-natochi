...
export default function WaitingListEmail({
  ...
  const preview = `Lista de Espera - Platanus Hack 25, ${githubUsername}`;
  ...
  return (
    <EmailLayout preview={preview}>
      <Section>
        <Heading style={h1}>LISTA DE ESPERA - PLATANUS HACK 25</Heading>
        ...
        <Text style={text}>
          ...
          semana completo (Viernes 21 de noviembre 18:30 hasta Domingo 23 de
          noviembre 15:30).
        </Text>
        ...
        <Text style={text}>
          Gracias por su interés en Platanus Hack 25,{' '}
