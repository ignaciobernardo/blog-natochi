...
export default function OnboardingCompleteEmail({
  ...
  const preview = `Todo listo para Platanus Hack 25`;
  ...
  return (
    <EmailLayout preview={preview}>
      <Section>
        ...
        <Text style={text}>¡Estás {readyText} para Platanus Hack 25 🎉!</Text>

        <Text style={text}>
          Te esperamos el <strong>viernes 21 de noviembre, a las 18:30</strong>{' '}
          en:
        </Text>

        <Text style={{ ...text, ...addressText }}>
          Roger de Flor 2725, Torre 3, Piso 3
          <br />
          Las Condes, Santiago
        </Text>
        ...
        <Text style={smallText}>
          📅 Adjunto encontrarás un archivo .ics para agregar el evento a tu
          calendario.
        </Text>
      </Section>
    </EmailLayout>
