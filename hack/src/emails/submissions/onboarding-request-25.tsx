...
export default function OnboardingRequestEmail({
  ...
  const preview = `Platanus Hack 25 - Completa tu onboarding`;
  ...
  return (
    <EmailLayout preview={preview}>
      <Section>
        <Heading style={h1}>ONBOARDING - PLATANUS HACK 25</Heading>
        ...
        <Text style={text}>
          Se acerca Platanus Hack 25. Para confirmar tu asistencia, necesitamos
          que {isPlural ? 'completen' : 'completes'} información extra:
        </Text>
        ...
        <Text style={{ ...text, ...boldText }}>
          {isPlural ? 'Tienen' : 'Tienes'} hasta el {deadline} (hora de Chile)
