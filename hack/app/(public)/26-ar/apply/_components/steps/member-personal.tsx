...
const VALIDATION = {
  email: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
  github: isValidGitHubProfileUrl,
  linkedin: isValidLinkedInProfileUrl,
};

const VALIDATION_MESSAGES = {
  email: 'Please enter a valid email address',
  github: GITHUB_PROFILE_URL_MESSAGE,
  linkedin: LINKEDIN_PROFILE_URL_MESSAGE,
};
...
export function MemberPersonal({ memberIndex }: MemberPersonalProps) {
  ...
  const validateField = (field: string, value: string): string | null => {
    ...
    if (field === 'githubProfile' && !VALIDATION.github(value)) {
      return VALIDATION_MESSAGES.github;
    }
    if (field === 'linkedinProfile' && !VALIDATION.linkedin(value)) {
