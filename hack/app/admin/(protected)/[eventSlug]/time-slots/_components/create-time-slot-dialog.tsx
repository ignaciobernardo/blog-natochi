...
import { createTimeSlotAction } from '../_actions/create-time-slot.action';

interface CreateTimeSlotDialogProps {
  eventId: string;
}

export function CreateTimeSlotDialog({ eventId }: CreateTimeSlotDialogProps) {
  const [open, setOpen] = useState(false);

  const { form, handleSubmit, serverState, isPending } =
    useFormAction<TimeSlotFormData>({
      schema: timeSlotFormSchema,
      action: createTimeSlotAction,
      defaultValues: {
        eventId,
        title: '',
        description: '',
        startTime: new Date('2025-11-21T18:30:00-03:00'),
        endTime: new Date('2025-11-21T20:30:00-03:00'),
        location: '',
        color: '#e1ff00',
        target: [],
      },
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Add a new time slot to the event schedule.
            </DialogDescription>
          </DialogHeader>
