...
): Promise<FormActionState<AdditionalInfoFormData>> {
  try {
    ...
    const validatedData = additionalInfoFormSchema.parse(data);
    ...
    if (isCommonError(error)) {
      return handleCommonError<AdditionalInfoFormData>(error);
    }
