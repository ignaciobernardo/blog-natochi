    ...
    const pollInterval = setInterval(async () => {
      try {
        ...
        if (response.ok) {
          ...
          if (data.trackSelectionStartTime) {
            const newTime = new Date(data.trackSelectionStartTime);
