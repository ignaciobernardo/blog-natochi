Agrega grants, programs o fellowships a la página /latam-opportunity-index del blog y pushea a GitHub.
...
Pasos:
1. Lee el archivo `latam-opportunity-index/index.html`
...
4. Hace git add del archivo `latam-opportunity-index/index.html`
