Agrega grants, programs o fellowships a la página /loi del blog y pushea a GitHub.
...
Pasos:
1. Lee el archivo `loi/index.html`
...
4. Hace git add del archivo `loi/index.html`
